...
export default {
  ...
  methods: {
    ...
    listCityCinema() {
      ...
      let latitude = window.localStorage.getItem("DATA_LATITUDE")
        ? window.localStorage.getItem("DATA_LATITUDE")
        : vm.$store.state.position.lat
        ? window.localStorage.getItem("DATA_LATITUDE")
        : "";
      let longitude = window.localStorage.getItem("DATA_LONGITUDE")
        ? window.localStorage.getItem("DATA_LONGITUDE")
